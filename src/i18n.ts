...
const en = {
  ...
  auth: {
    ...
    androidOpening: 'Opening Google sign in…',
    androidWaiting: 'Waiting for Google…',
    androidExchanging: 'Completing sign in…',
    androidTimeout: 'Sign in timed out.',
    androidTimeoutNote: 'No response received. Please try again.',
    androidFailed: 'Sign in failed.',
    androidCancel: 'Cancel',
    androidRetry: 'Try again',
    orDivider: 'or',
  ...
  interaction: {
    ...
    communityTitle: 'Community distribution',
    ...
    skipQuestion: 'Skip',
    swapQuestion: 'Swap question',
    exitToMenu: 'Exit to menu',
    distributionLabels: {
      'Estimated distribution': 'Estimated distribution',
      'Early community signal': 'Early community signal',
  ...
  reward: {
    ...
    blockLabel: {
      community_reveal: 'Community distribution',
  ...
  legal: {
    back: '← Back',
    placeholder: 'Draft — requires legal review before launch.',
    ...
    privacySections: {
      ...
      behavioralEvents: 'Behavioral signals',
    ...
    privacyBodies: {
      dataController: 'The Other 99 is operated by its creators. Questions about data can be sent to the contact address in the Help section.',
      dataCollected: 'We collect: answers you submit, timing signals (how long you take to answer), interaction patterns (skips, swaps, exits), account email if you register, and app settings (language, theme). We do not collect precise location, contacts, or financial data.',
      dataUsage: 'Your data is used to build your personality profile and show you comparisons. It is not sold to third parties. Aggregated, non-identifiable statistics may be used to improve content quality.',
      accountData: 'If you create an account, your email address is stored in Supabase (our database provider) to identify your session. You can delete your account and all associated data at any time.',
      answerData: 'Your answers and derived personality dimensions are stored locally on your device and, if you are logged in, in our database. Community statistics shown during the app are estimated distributions — not real-time data from other users unless clearly labelled as such.',
      behavioralEvents: 'The app records behavioral signals: whether you skip or swap a question, how long you spend before answering, and whether you exit mid-session. These signals refine your behavioral profile — they are never used to judge or diagnose you, and they are not shared with third parties.',
      localStorageLabel: 'Profile data, session state, and settings are stored in your browser\'s localStorage. This data stays on your device. You can export or delete it at any time from Settings.',
      analytics: 'We do not use advertising cookies. We may use minimal analytics to understand app usage patterns. No tracking pixels or third-party ad networks are used.',
      userRights: 'You have the right to: access your data (use the Export function in Settings), delete your local data (use Reset in Settings), delete your account (coming soon), and ask questions about how your data is used.',
      contact: 'For data questions or deletion requests, use the Help & Contact section or the email address listed there.',
    },
    ...
    subscriptionBodies: {
      price: 'Premium pricing is shown at the point of purchase. Prices may vary by region.',
      billing: 'Premium is billed as a one-time purchase or subscription depending on the offer shown. The exact billing period is confirmed before purchase.',
      cancellation: 'You can cancel a subscription at any time through your device\'s app store account settings. Cancellation takes effect at the end of the current billing period.',
      renewal: 'Subscriptions renew automatically unless cancelled before the renewal date. You will be notified before renewal.',
      refund: 'Refund eligibility is governed by Apple App Store or Google Play Store policies. Contact us if you believe a charge was made in error.',
      access: 'Premium unlocks deeper profile layers including Hidden Parameters, Shadow Profile, Human Twin comparison, and other analytical modules. These are self-discovery tools, not clinical assessments.',
    },
    termsBody: 'By using The Other 99, you agree that:\n\n• The app is an entertainment and self-discovery tool, not a medical or psychological assessment.\n• The personality insights shown are estimates based on your responses, not diagnoses.\n• Community comparison statistics are estimated or early-stage data unless clearly marked otherwise.\n• You are responsible for the accuracy of any information you provide.\n• The app is intended for users aged 16 and over.\n• We reserve the right to update these terms. Continued use of the app after an update constitutes acceptance.\n\nFull terms are subject to legal review before commercial launch.',
    helpBody: 'For help, questions, or feedback, contact the team via the email address in the app store listing or on the project\'s public page. Bug reports and feature suggestions are welcome.',
  },
  subscription: {
    title: 'Premium',
...
const pl: T = {
  ...
  auth: {
    ...
    androidOpening: 'Otwieranie logowania Google…',
    androidWaiting: 'Oczekiwanie na Google…',
    androidExchanging: 'Finalizowanie logowania…',
    androidTimeout: 'Logowanie przekroczyło czas oczekiwania.',
    androidTimeoutNote: 'Brak odpowiedzi. Spróbuj ponownie.',
    androidFailed: 'Logowanie nie powiodło się.',
    androidCancel: 'Anuluj',
    androidRetry: 'Spróbuj ponownie',
    orDivider: 'lub',
  ...
  interaction: {
    ...
    skipQuestion: 'Pomiń',
    swapQuestion: 'Zamień pytanie',
    exitToMenu: 'Wyjdź do menu',
    distributionLabels: {
      'Estimated distribution': 'Szacowany rozkład',
      'Early community signal': 'Wczesny sygnał społeczności',
      'Community distribution': 'Rozkład społeczności',
      'Not enough data yet': 'Jeszcze za mało danych',
    } as Record<string, string>,
    reveal: {
  ...
  legal: {
    ...
    privacySections: {
      ...
      behavioralEvents: 'Sygnały behawioralne',
    ...
    privacyBodies: {
      dataController: 'The Other 99 jest prowadzony przez twórców aplikacji. Pytania dotyczące danych można kierować na adres podany w sekcji Pomoc.',
      dataCollected: 'Zbieramy: Twoje odpowiedzi, sygnały czasowe (jak długo odpowiadasz), wzorce interakcji (pominięcia, zamiany pytań, wyjścia z sesji), adres e-mail jeśli się rejestrujesz, ustawienia aplikacji (język, motyw). Nie zbieramy dokładnej lokalizacji, kontaktów ani danych finansowych.',
      dataUsage: 'Twoje dane służą do budowania Twojego profilu osobowości i wyświetlania porównań. Nie są sprzedawane stronom trzecim. Zagregowane, niezidentyfikowane statystyki mogą być używane do poprawy jakości treści.',
      accountData: 'Jeśli zakładasz konto, adres e-mail jest przechowywany w Supabase (nasz dostawca bazy danych) w celu identyfikacji sesji. Możesz usunąć swoje konto i wszystkie powiązane dane w dowolnym momencie.',
      answerData: 'Twoje odpowiedzi i wynikające z nich wymiary osobowości są przechowywane lokalnie na Twoim urządzeniu oraz, jeśli jesteś zalogowany, w naszej bazie danych. Statystyki społeczności wyświetlane w aplikacji to szacowane rozkłady — nie dane w czasie rzeczywistym od innych użytkowników, chyba że wyraźnie oznaczono inaczej.',
      behavioralEvents: 'Aplikacja rejestruje sygnały behawioralne: czy pomijasz lub zamieniasz pytanie, jak długo spędzasz przed udzieleniem odpowiedzi, czy wychodzisz w trakcie sesji. Sygnały te uszczegóławiają Twój profil — nigdy nie służą do oceniania ani diagnozowania Cię i nie są udostępniane stronom trzecim.',
      localStorageLabel: 'Dane profilu, stan sesji i ustawienia są przechowywane w localStorage Twojej przeglądarki. Te dane pozostają na Twoim urządzeniu. Możesz je wyeksportować lub usunąć w dowolnym momencie z poziomu Ustawień.',
      analytics: 'Nie używamy reklamowych plików cookie. Możemy korzystać z minimalnej analityki w celu zrozumienia wzorców użytkowania aplikacji. Nie są używane piksele śledzące ani sieci reklamowe stron trzecich.',
      userRights: 'Masz prawo do: dostępu do swoich danych (użyj funkcji Eksport w Ustawieniach), usunięcia lokalnych danych (użyj Resetuj w Ustawieniach), usunięcia konta (wkrótce dostępne) oraz zadawania pytań dotyczących sposobu przetwarzania danych.',
      contact: 'W sprawach dotyczących danych lub wniosków o usunięcie skontaktuj się przez sekcję Pomoc i kontakt lub wskazany tam adres e-mail.',
    },
    subscriptionSections: {
      price: 'Cena',
    ...
    subscriptionBodies: {
      price: 'Ceny premium są wyświetlane w momencie zakupu. Ceny mogą się różnić w zależności od regionu.',
      billing: 'Premium jest rozliczane jako jednorazowy zakup lub subskrypcja w zależności od wyświetlanej oferty. Dokładny okres rozliczeniowy jest potwierdzany przed zakupem.',
      cancellation: 'Subskrypcję możesz anulować w dowolnym momencie przez ustawienia konta w sklepie aplikacji na swoim urządzeniu. Anulowanie jest skuteczne na koniec bieżącego okresu rozliczeniowego.',
      renewal: 'Subskrypcje odnawiają się automatycznie, chyba że anulujesz przed datą odnowienia. Przed odnowieniem zostaniesz poinformowany.',
      refund: 'Prawo do zwrotu podlega zasadom sklepu Apple App Store lub Google Play Store. Skontaktuj się z nami jeśli uważasz, że opłata została pobrana błędnie.',
      access: 'Premium odblokowuje głębsze warstwy profilu, w tym Ukryte Parametry, Profil Cienia, porównanie Ludzkiego Bliźniaka i inne moduły analityczne. Są to narzędzia do samopoznania, a nie oceny kliniczne.',
    },
    termsBody: 'Korzystając z The Other 99, zgadzasz się, że:\n\n• Aplikacja jest narzędziem rozrywkowym i służącym do samopoznania, a nie oceną medyczną ani psychologiczną.\n• Prezentowane spostrzeżenia osobowościowe są szacunkami opartymi na Twoich odpowiedziach, a nie diagnozami.\n• Statystyki porównania społeczności to szacowane lub wczesne dane, chyba że wyraźnie oznaczono inaczej.\n• Jesteś odpowiedzialny za dokładność informacji, które podajesz.\n• Aplikacja jest przeznaczona dla użytkowników w wieku co najmniej 16 lat.\n• Zastrzegamy sobie prawo do aktualizacji tych warunków. Dalsze korzystanie z aplikacji po aktualizacji oznacza akceptację.\n\nPełne warunki podlegają weryfikacji prawnej przed komercyjną premierą.',
    helpBody: 'W przypadku pytań, pomocy lub opinii skontaktuj się z zespołem przez adres e-mail wskazany w sklepie z aplikacjami lub na publicznej stronie projektu. Raporty o błędach i propozycje funkcji są mile widziane.',
  },
  subscription: {
    title: 'Premium',
